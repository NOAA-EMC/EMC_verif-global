...
class PlotSpecs:
    ...
    def get_var_plot_name(self, var_name, var_level):
        ...
        var_plot_name_dict = {
            ...
            'RH/Z2' : '2m Relative Humidity',
            'DPT/Z2': '2m  Dewpoint Temperature',
            'GUST/Z0': 'Surface Wind Gust',
            'HGT/L0': 'Cloud Ceiling',
        ...
        """! Construct the full path to save the plot
             ...
             Returns:
                 image_path - full path of the name the plot will
                              be saved as (string)
        """
        component_savefig_name = 'grid2obs'
