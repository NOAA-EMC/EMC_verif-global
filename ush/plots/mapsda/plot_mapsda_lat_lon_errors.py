...
noaa_logo_img_array = matplotlib.image.imread(
    os.path.join(os.environ['USHverif_global'], 'plots', 'mapsda', 'logos',
                 'noaa.png')
)
noaa_logo_alpha = 0.5
...
def plot_subplot_data(ax_tmp, map_ax_tmp, plot_data, plot_data_lat,
    ...
    # Get area average
    plot_data_area_avg = mapsda_plot_util.calculate_area_average(
            ...
            if not os.path.exists(input_file):
                ...
                if RUN_type == 'gdas':
                    if stat == 'inc':
                        ...
                        if get_inc_levels:
                            levels_plot = mapsda_plot_util.get_clevels(stat_data,
                                                                       1.25)
