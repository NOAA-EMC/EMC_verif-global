...
if RUN == 'grid2grid_step1':
    ...
    gdas_by = os.environ['mapsda_gdas_make_met_data_by']
    ens_by = os.environ['mapsda_ens_make_met_data_by']
    ...
    hr_end = hr_list[-1]
    hr_inc = int((24/nhr)*3600)
    env_var_dict['mapsda_gdas_make_met_data_by'] = gdas_by
    env_var_dict['mapsda_ens_make_met_data_by'] = ens_by
    ...
    env_var_dict['mapsda_ens_guess_hour'] = str(ens_guess_hour.zfill(2))
