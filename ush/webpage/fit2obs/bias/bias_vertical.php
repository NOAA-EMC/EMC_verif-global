...
domains.push({
        displayName: "Europe",
        name: "<?php echo $Eur_name; ?>",
});
domains.push({
        displayName: "Asia",
        name: "<?php echo $Asia_name; ?>",
});
domains.push({
        displayName: "All",
        name: "<?php echo $AllReg_name; ?>",
});


levels.push({
        displayName: "Troposphere",
        name: "<?php echo $Tropo_name; ?>",
});
levels.push({
        displayName: "Stratosphere",
        name: "<?php echo $Strato_name; ?>",
});


seasons.push({
        displayName: "<?php echo $Exp1_name; ?> 00Z",
        name: "<?php echo $Exp1_00_name; ?>",
});
seasons.push({
        displayName: "<?php echo $Exp2_name; ?> 00Z",
        name: "<?php echo $Exp2_00_name; ?>",
});
seasons.push({
        displayName: "<?php echo $Exp1_name; ?> 12Z",
        name: "<?php echo $Exp1_12_name; ?>",
});
seasons.push({
        displayName: "<?php echo $Exp2_name; ?> 12Z",
        name: "<?php echo $Exp2_12_name; ?>",
});
seasons.push({
        displayName: "Anl/Ges 00Z",
        name: "<?php echo $AnlGes_00_name; ?>",
});
seasons.push({
        displayName: "Anl/Ges 12Z",
        name: "<?php echo $AnlGes_12_name; ?>",
});
seasons.push({
        displayName: "Fhr12/Fhr36",
        name: "<?php echo $Fhr12_Fhr36_name; ?>",
});
seasons.push({
        displayName: "Fhr24/Fhr48",
        name: "<?php echo $Fhr24_Fhr48_name; ?>",
});
seasons.push({
        displayName: "fhr 00",
...
maptypes.push({
        url: "bias_horizontal.php",
        displayName: "Horizontal",
        name: "bias_horizontal",
});
maptypes.push({
        url: "bias_vertical.php",
