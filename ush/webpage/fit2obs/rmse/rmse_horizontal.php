...
*/
var url = "<?php echo $horizontal_url; ?>";
...
seasons.push({
        displayName: "All-<?php echo $Exp1_name; ?>",
        name: "<?php echo $LeadAllExp1_name; ?>",
});
seasons.push({
        displayName: "All-<?php echo $Exp2_name; ?>",
        name: "<?php echo $LeadAllExp2_name; ?>",
});
