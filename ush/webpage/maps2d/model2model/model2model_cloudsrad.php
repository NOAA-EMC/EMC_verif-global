...
*/
var url = "<?php echo $CloudsRad_url; ?>";
...
variables.push({
        displayName: "Surface Longwave Downwelling Flux",
        name: "<?php echo $cloudsrad_DownLWRadFlxSfc_name; ?>",
});
variables.push({
        displayName: "Surface Longwave Upwelling Flux",
        name: "<?php echo $cloudsrad_UpLWRadFlxSfc_name; ?>",
});
variables.push({
        displayName: "TOA Longwave Upwelling Flux",
        name: "<?php echo $cloudsrad_UpLWRadFlxTOA_name; ?>",
});
variables.push({
        displayName: "Surface Shortwave Downwelling Flux",
        name: "<?php echo $cloudsrad_DownSWRadFlxSfc_name; ?>",
});
variables.push({
        displayName: "Surface Shortwave Upwelling Flux",
        name: "<?php echo $cloudsrad_UpSWRadFlxSfc_name; ?>",
});
variables.push({
        displayName: "TOA Shortwave Upwelling Flux",
        name: "<?php echo $cloudsrad_UpSWRadFlxTOA_name; ?>",
});
variables.push({
        displayName: "Surface Albedo",
        name: "<?php echo $cloudsrad_AlbdoSfc_name; ?>",
});
variables.push({
        displayName: "Sunshine Duration",
        name: "<?php echo $cloudsrad_SunDurSfc_name; ?>",
});
variables.push({
        displayName: "Total Cloud Cover",
        name: "<?php echo $cloudsrad_CldFracClm_name; ?>",
});
variables.push({
        displayName: "PBL Cloud Cover",
        name: "<?php echo $cloudsrad_CldFracPBL_name; ?>",
});
variables.push({
        displayName: "Low Cloud Cover",
        name: "<?php echo $cloudsrad_CldFracLow_name; ?>",
});
variables.push({
        displayName: "Mid Cloud Cover",
        name: "<?php echo $cloudsrad_CldFracMid_name; ?>",
});
variables.push({
        displayName: "High Cloud Cover",
        name: "<?php echo $cloudsrad_CldFracHigh_name; ?>",
});
variables.push({
        displayName: "Convective Cloud Cover",
        name: "<?php echo $cloudsrad_CldFracCnv_name; ?>",
});
variables.push({
        displayName: "Low Cloud Base Pressure",
        name: "<?php echo $cloudsrad_CldBasePresLow_name; ?>",
});
variables.push({
        displayName: "Mid Cloud Base Pressure",
        name: "<?php echo $cloudsrad_CldBasePresMid_name; ?>",
});
variables.push({
        displayName: "High Cloud Base Pressure",
        name: "<?php echo $cloudsrad_CldBasePresHigh_name; ?>",
});
variables.push({
        displayName: "Convective Cloud Base Pressure",
        name: "<?php echo $cloudsrad_CldBasePresCnv_name; ?>",
});
variables.push({
        displayName: "Low Cloud Top Pressure",
        name: "<?php echo $cloudsrad_CldTopPresLow_name; ?>",
});
variables.push({
        displayName: "Mid Cloud Top Pressure",
        name: "<?php echo $cloudsrad_CldTopPresMid_name; ?>",
});
variables.push({
        displayName: "High Cloud Top Pressure",
        name: "<?php echo $cloudsrad_CldTopPresHigh_name; ?>",
});
variables.push({
        displayName: "Convective Cloud Top Pressure",
        name: "<?php echo $cloudsrad_CldTopPresCnv_name; ?>",
});
variables.push({
        displayName: "Low Cloud Top Temperature",
        name: "<?php echo $cloudsrad_CldTopTempLow_name; ?>",
});
variables.push({
        displayName: "Mid Cloud Top Temperature",
        name: "<?php echo $cloudsrad_CldTopTempMid_name; ?>",
});
variables.push({
        displayName: "High Cloud Top Temperature",
        name: "<?php echo $cloudsrad_CldTopTempHigh_name; ?>",
});
variables.push({
        displayName: "Total Column Cloud Work",
        name: "<?php echo $cloudsrad_CldWrkClm_name; ?>",
});
variables.push({
        displayName: "Cloud Water",
        name: "<?php echo $cloudsrad_CldWtrClm_name; ?>",
});
...
function initialize(){
        ...
        imageObj = {
                variable: "<?php echo $cloudsrad_DownSWRadFlxSfc_name; ?>",
