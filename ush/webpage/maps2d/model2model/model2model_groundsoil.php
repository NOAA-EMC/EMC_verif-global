...
*/
var url = "<?php echo $GroundSoil_url; ?>";
...
variables.push({
        ...
        name: "<?php echo $groundsoil_TempSfc_name; ?>",
});
variables.push({
        displayName: "Soil Temperature 0-10cm",
        name: "<?php echo $groundsoil_SoilTemp0_10cm_name; ?>",
});
variables.push({
        displayName: "Soil Temperature 10-40cm",
        name: "<?php echo $groundsoil_SoilTemp10_40cm_name; ?>",
});
variables.push({
        displayName: "Soil Temperature 40-100cm",
        name: "<?php echo $groundsoil_SoilTemp40_100cm_name; ?>",
});
variables.push({
        displayName: "Soil Temperature 100-200cm",
        name: "<?php echo $groundsoil_SoilTemp100_200cm_name; ?>",
});
variables.push({
        displayName: "Soil Volumetric Moisture 0-10cm",
        name: "<?php echo $groundsoil_SoilVolMoist0_10cm_name; ?>",
});
variables.push({
        displayName: "Soil Volumetric Moisture 10-40cm",
        name: "<?php echo $groundsoil_SoilVolMoist10_40cm_name; ?>",
});
variables.push({
        displayName: "Soil Volumetric Moisture 40-100cm",
        name: "<?php echo $groundsoil_SoilVolMoist40_100cm_name; ?>",
});
variables.push({
        displayName: "Soil Volumetric Moisture 100-200cm",
        name: "<?php echo $groundsoil_SoilVolMoist100_200cm_name; ?>",
});
variables.push({
        displayName: "Surface Latent Heat Flux",
        name: "<?php echo $groundsoil_LatHeatFlxSfc_name; ?>",
});
variables.push({
        displayName: "Surface Sensible Heat Flux",
        name: "<?php echo $groundsoil_SensHeatFlxSfc_name; ?>",
});
variables.push({
        displayName: "Ground Heat Flux",
        name: "<?php echo $groundsoil_GrndHeatFlxSfc_name; ?>",
});
variables.push({
        displayName: "Runoff",
        name: "<?php echo $groundsoil_RnoffSfc_name; ?>",
});
variables.push({
        displayName: "Field Capacity",
        name: "<?php echo $groundsoil_FieldCapSfc_name; ?>",
});
variables.push({
        displayName: "Wilting Point",
        name: "<?php echo $groundsoil_WiltPtSfc_name; ?>",
});
variables.push({
        displayName: "Potential Evaporation Rate",
        name: "<?php echo $groundsoil_PotEvpRateSfc_name; ?>",
});
...
function initialize(){
        ...
        imageObj = {
                variable: "<?php echo $groundsoil_TempSfc_name; ?>",
