...
variables.push({
        displayName: "Height",
        name: "<?php echo $pbl_HgtPBL_name; ?>",
});
variables.push({
        displayName: "Ventilation Rate",
        name: "<?php echo $pbl_VentRatePBL_name; ?>",
});
variables.push({
        displayName: "Zonal Wind",
        name: "<?php echo $pbl_ZonWindPBL_name; ?>",
});
variables.push({
        displayName: "Meridional Wind",
        name: "<?php echo $pbl_MerWindPBL_name; ?>",
});
variables.push({
        displayName: "Cloud Cover",
        name: "<?php echo $pbl_CldFracPBL_name; ?>",
});
...
function initialize(){
        ...
        imageObj = {
                variable: "<?php echo $pbl_HgtPBL_name; ?>",
