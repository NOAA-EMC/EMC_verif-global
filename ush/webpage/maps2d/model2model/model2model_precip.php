...
variables.push({
        ...
        name: "<?php echo $precip_TotPrecip_name; ?>",
});
variables.push({
        displayName: "Convective Precipitation",
        name: "<?php echo $precip_CnvPrecip_name; ?>",
});
variables.push({
        displayName: "Accumulated Snow Water Equiv.",
        name: "<?php echo $precip_WtrEqvSnoDep_name; ?>",
});
variables.push({
        displayName: "Precipitation Rate",
        name: "<?php echo $precip_PrecipRate_name; ?>",
});
variables.push({
        displayName: "Snow Depth",
        name: "<?php echo $precip_SnoDep_name; ?>",
});
variables.push({
        displayName: "Runoff",
        name: "<?php echo $precip_RnoffSfc_name; ?>",
});
variables.push({
        displayName: "Categorical Rain",
        name: "<?php echo $precip_CatRain_name; ?>",
});
variables.push({
        displayName: "Categorical Snow",
        name: "<?php echo $precip_CatSno_name; ?>",
});
variables.push({
        displayName: "Categorical Ice Pellets",
        name: "<?php echo $precip_CatIcePel_name; ?>",
});
variables.push({
        displayName: "Categorical Freezing Rain",
        name: "<?php echo $precip_CatFrzRain_name; ?>",
});
...
function initialize(){
        ...
        imageObj = {
                variable: "<?php echo $precip_TotPrecip_name; ?>",
