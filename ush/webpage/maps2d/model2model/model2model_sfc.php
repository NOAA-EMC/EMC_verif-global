...
variables.push({
        ...
        name: "<?php echo $sfc_Temp2m_name; ?>",
});
variables.push({
        displayName: "2m Max. Temperature",
        name: "<?php echo $sfc_Temp2mMax_name; ?>",
});
variables.push({
        displayName: "2m Min. Temperature",
        name: "<?php echo $sfc_Temp2mMin_name; ?>",
});
variables.push({
        displayName: "Skin Temperature",
        name: "<?php echo $sfc_TempSfc_name; ?>",
});
variables.push({
        displayName: "2m Dewpoint",
        name: "<?php echo $sfc_Dewpt2m_name; ?>",
});
variables.push({
        displayName: "2m Relative Humidity",
        name: "<?php echo $sfc_RelHum2m_name; ?>",
});
variables.push({
        displayName: "2m Specific Humidity",
        name: "<?php echo $sfc_SpefHum2m_name; ?>",
});
variables.push({
        displayName: "10m Zonal Wind",
        name: "<?php echo $sfc_ZonWind10m_name; ?>",
});
variables.push({
        displayName: "10m Meridional Wind",
        name: "<?php echo $sfc_MerWind10m_name; ?>",
});
variables.push({
        displayName: "Wind Gust",
        name: "<?php echo $sfc_WindGustSfc_name; ?>",
});
variables.push({
        displayName: "Surface Pressure",
        name: "<?php echo $sfc_PresSfc_name; ?>",
});
variables.push({
        displayName: "Pressure reduced to Mean Sea-level",
        name: "<?php echo $sfc_Pres2MeanSeaLev_name; ?>",
});
variables.push({
        displayName: "Mean Sea-level Pressure",
        name: "<?php echo $sfc_MeanSeaLevPres_name; ?>",
});
variables.push({
        displayName: "Lifted Index",
        name: "<?php echo $sfc_LifIdxSfc_name; ?>",
});
variables.push({
        displayName: "Best 4-layer Lifted Index",
        name: "<?php echo $sfc_Best4LyrLifIdxSfc_name; ?>",
});
variables.push({
        displayName: "Visibilty",
        name: "<?php echo $sfc_VisSfc_name; ?>",
});
variables.push({
        displayName: "Geopotential Height",
        name: "<?php echo $sfc_HgtSfc_name; ?>",
});
variables.push({
        displayName: "Heat Index",
        name: "<?php echo $sfc_HeatIdxSfc_name; ?>",
});
variables.push({
        displayName: "Ice Concentration",
        name: "<?php echo $sfc_IceConSfc_name; ?>",
});
variables.push({
        displayName: "Zonal Gravity Wave Stress Flux",
        name: "<?php echo $sfc_ZonGWSFlxSfc_name; ?>",
});
variables.push({
        displayName: "Meridional Gravity Wave Stress Flux",
        name: "<?php echo $sfc_MerGWSFlxSfc_name; ?>",
});
variables.push({
        displayName: "Zonal Momentum Flux",
        name: "<?php echo $sfc_ZonMomtmFlxSfc_name; ?>",
});
variables.push({
        displayName: "Meridional Momentum Flux",
        name: "<?php echo $sfc_MerMomtmFlxSfc_name; ?>",
});
variables.push({
        displayName: "Albedo",
        name: "<?php echo $sfc_AlbdoSfc_name; ?>",
});
variables.push({
        displayName: "Latent Heat Flux",
        name: "<?php echo $sfc_LatHeatFlxSfc_name; ?>",
});
variables.push({
        displayName: "Sensible Heat Flux",
        name: "<?php echo $sfc_SensHeatFlxSfc_name; ?>",
});
variables.push({
        displayName: "Ground Heat Flux",
        name: "<?php echo $sfc_GrndHeatFlxSfc_name; ?>",
});
...
function initialize(){
        ...
        imageObj = {
                variable: "<?php echo $sfc_Temp2m_name; ?>",
