...
/*
When constructing the URL below, DDD = domain, VVV = variable, LLL = level, PPP = type, TTT = validtime.
*/
...
types.push({
        displayName: "Threshold Average",
        name: "<?php echo $ThreshMean_name; ?>",
});
types.push({
        displayName: "Threshold By Lead",
        name: "<?php echo $ThreshByLead_name; ?>",
});
...
timeseries_domains = ["024", "048", "072", "096", "120", "144", "168", "192", "216", "240"]
fhrmean_domains = ["All"]
timeseries_levels = ["0.2", "2", "5", "10", "15", "25", "35", "50", "75"]
threshmean_levels = ["All"]
...
function initialize(){
        ...
        imageObj = {
                domain: "<?php echo $Day1_name; ?>",
                variable: "<?php echo $CONUS_name; ?>",
