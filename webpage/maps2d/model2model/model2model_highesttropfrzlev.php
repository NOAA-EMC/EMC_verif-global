...
*/
var url = "<?php echo $HighestTropFrzLev_url; ?>";
...
variables.push({
        ...
        name: "<?php echo $highesttropfrzlev_HgtHighTropFrzLev_name; ?>",
});
variables.push({
        displayName: "Relative Humidity",
        name: "<?php echo $highesttropfrzlev_RelHumHighTropFrzLev_name; ?>",
});
...
function initialize(){
        ...
        imageObj = {
                variable: "<?php echo $highesttropfrzlev_HgtHighTropFrzLev_name; ?>",
