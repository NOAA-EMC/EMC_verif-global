...
*/
var url = "<?php echo $MaxWindLev_url; ?>";
...
variables.push({
        ...
        name: "<?php echo $maxwindlev_TempMaxWindLev_name; ?>",
});
variables.push({
        displayName: "Pressure",
        name: "<?php echo $maxwindlev_PresMaxWindLev_name; ?>",
});
variables.push({
        displayName: "Geopotential Height",
        name: "<?php echo $maxwindlev_HgtMaxWindLev_name; ?>",
});
variables.push({
        displayName: "Zonal Wind",
        name: "<?php echo $maxwindlev_ZonWindMaxWindLev_name; ?>",
});
variables.push({
        displayName: "Meridional Wind",
        name: "<?php echo $maxwindlev_MerWindMaxWindLev_name; ?>",
});
variables.push({
        displayName: "ICAO Std. Atmos. Ref. Height",
        name: "<?php echo $maxwindlev_ICAOHgtMaxWindLev_name; ?>",
});
...
function initialize(){
        ...
        imageObj = {
                variable: "<?php echo $maxwindlev_HgtMaxWindLev_name; ?>",
