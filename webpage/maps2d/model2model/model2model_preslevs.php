...
variables.push({
        ...
        name: "<?php echo $preslevs_Temp_name; ?>",
});
variables.push({
        displayName: "Geopotential Height",
        name: "<?php echo $preslevs_Hgt_name; ?>",
});
variables.push({
        displayName: "Zonal wind",
        name: "<?php echo $preslevs_UWnd_name; ?>",
});
variables.push({
        displayName: "Meridonal wind",
        name: "<?php echo $preslevs_VWnd_name; ?>",
});
variables.push({
        displayName: "Vertical Velocity",
        name: "<?php echo $preslevs_VertVel_name; ?>",
});
variables.push({
        displayName: "Relative Humidity",
        name: "<?php echo $preslevs_RelHum_name; ?>",
});
variables.push({
        displayName: "Cloud Water",
        name: "<?php echo $preslevs_CldWat_name; ?>",
});
variables.push({
        displayName: "Ozone",
        name: "<?php echo $preslevs_Ozne_name; ?>",
});
...
function initialize(){
        ...
        imageObj = {
                variable: "<?php echo $preslevs_Temp_name; ?>",
