...
variables.push({
        displayName: "Total Ozone",
        name: "<?php echo $totcol_TotOzneClm_name; ?>",
});
variables.push({
        displayName: "Cloud Work",
        name: "<?php echo $totcol_CldWrkClm_name; ?>",
});
variables.push({
        displayName: "Relative Humidity",
        name: "<?php echo $totcol_RelHumClm_name; ?>",
});
