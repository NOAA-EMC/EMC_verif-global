...
<?php include "model2obs_globalvars.php"; ?>
...
variables.push({
        displayName: "Atmos. Shortwave Absorption",
        name: "<?php echo $cloudsrad_SWAbsorb_name; ?>",
});
variables.push({
        displayName: "Atmos. Longwave Emittance",
        name: "<?php echo $cloudsrad_LWEmit_name; ?>",
});
variables.push({
        displayName: "Shortwave Surface Albedo",
        name: "<?php echo $cloudsrad_SWAlbdoSfc_name; ?>",
});
variables.push({
...
maptypes.push({
        url: "model2obs_cloudsrad.php",
        displayName: "Clouds and Radiation",
        name: "model2obs_cloudsrad",
});
maptypes.push({
        url: "model2obs_sfc.php",
        displayName: "Surface",
        name: "model2obs_sfc",
});
maptypes.push({
        url: "model2obs_totcol.php",
        displayName: "Total Column",
        name: "model2obs_totcol",
});
maptypes.push({
        url: "model2obs_precip.php",
        displayName: "Precipitation",
        name: "model2obs_precip",
});
